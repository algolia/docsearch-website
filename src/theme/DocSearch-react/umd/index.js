(function (global, factory) {
  ...
  (global = global || self, factory(global['docsearch-react'] = {}, global.React));
  ...
  function NoResultsScreen(props) {
    ...
    return React__default.createElement("div", {
    ...
    }, "No results for \"", React__default.createElement("strong", null, props.state.query), "\"."), searchSuggestions && searchSuggestions.length > 0 && React__default.createElement("p", null, "Try searching for", ' ', searchSuggestions.slice(0, 3).reduce(function (acc, search) {
      return [].concat(_toConsumableArray(acc), [React__default.createElement("button", {
      ...
      className: "DocSearch-Help"
    }, "If you believe this query should return results, please", ' ', React__default.createElement("a", {
  ...
  function ErrorScreen() {
    ...
    }, React__default.createElement("p", null, "We\u2018re unable to fetch results. You might want to check your network connection."));
  }
  ...
  function SearchButton(props) {
    ...
    }, React__default.createElement(SearchIcon, null), React__default.createElement("span", {
